<template>
  <div
    class="navbar navbar-expand navbar-light border-bottom-2"
    id="default-navbar"
    data-primary
  >
    <!-- Navbar toggler -->
    ...
    <a href="index.html" class="navbar-brand mr-16pt d-lg-none">
      ...
      <span class="avatar avatar-sm navbar-brand-icon mr-0 mr-lg-8pt">
        <span class="avatar-title rounded bg-primary"
          ><img
            src="/src/assets/public/images/illustration/student/128/white.svg"
            alt="logo"
            class="img-fluid"
        /></span>
      </span>
    ...
    >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          ...
          <a href="student-take-course.html" class="dropdown-item"
            ...
            ></a
          >
          <a href="student-take-lesson.html" class="dropdown-item"
            >Take Lesson</a
          >
          <a href="student-take-quiz.html" class="dropdown-item">Take Quiz</a>
          <a href="student-quiz-result-details.html" class="dropdown-item"
            >Quiz Result</a
          >
          ...
          <a href="student-quiz-results.html" class="dropdown-item"
            >My Quizzes</a
          >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          ...
          <a href="student-path-assessment.html" class="dropdown-item"
            >Skill Assessment</a
          >
          <a href="student-path-assessment-result.html" class="dropdown-item"
            >Skill Result</a
          >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          ...
          >
          <a href="instructor-courses.html" class="dropdown-item"
            >Manage Courses</a
          >
          <a href="instructor-quizzes.html" class="dropdown-item"
            >Manage Quizzes</a
          >
          <a href="instructor-earnings.html" class="dropdown-item">Earnings</a>
          <a href="instructor-statement.html" class="dropdown-item"
            >Statement</a
          >
          <a href="instructor-edit-course.html" class="dropdown-item"
            >Edit Course</a
          >
    ...
    <form
      class="search-form navbar-search d-none d-lg-flex mr-16pt"
      action="index.html"
